...
.e-4-wrap {
	background: #3b3b3b url(static/pages/images/error/404.jpg) no-repeat 0 0;
	margin: 5% auto 0;
	width: 640px;
	overflow: hidden;
}
		...
		<div class="fl-2">
			<div class="e-4-txt-wrap">
				...
				<div>
					...
					<p class="e-4-t-1">
						3、或者去 <a href="mainPage/index" title="首页" target="_top">首页</a> , <a
							href="javascript:window.history.go(-1)" title="返回">返回</a>
					</p>
					<p class="e-4-t-1">
						<a href="javascript:void(0)" onclick="showOrCloseErrorInfo()"
							class="c-green"> 查看详细异常</a>
					</p>
				</div>
			</div>
		</div>
	</div>
	<div id="error_div" style="display: none" style="align:left;">
		<%
			//show error message
			if (exception != null) {
